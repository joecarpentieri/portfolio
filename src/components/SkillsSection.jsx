...
export const SkillsSection = () => {
  ...
  const filteredSkills = skills.filter((skill) => activeCategory === "all" || skill.category === activeCategory); // if category is all, keep all categories, if a specific category only keep those in that category
