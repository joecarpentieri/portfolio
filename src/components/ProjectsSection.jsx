...
const projects = [
  {
    id: 1,
    title: "Backend Gratitude Journal",
...
export const ProjectsSection = () => {
  return  <section id="projects" className="py-24 px-4 relative">
    <div className="container mx-auto max-w-5xl">
      ...
      <p className="text-center text-muted foreground-color mb-12 max-w-2xl mx-auto">Here are some of my recent project, displaying work in back-end, front-end and full-stack applications.</p>
      ...
      <div className="text-center mt-12">
        <a className="cosmic-button w-fit flex items-center mx-auto gap-2" target="_blank" href="https://github.com/joecarpentieri">
          Check Out My GitHub <ArrowRight size={16}></ArrowRight>
        </a>
      </div>
